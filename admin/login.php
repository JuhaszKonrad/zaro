...
if (isset($_POST['submit'])) {
    ...
    //Error kiküszöbölése ha speciális karakter kerül beírásra
    $felhasználónév = mysqli_real_escape_string($kapcs,$_POST['felhasználónév']);
    $jelszó = mysqli_real_escape_string($kapcs,md5($_POST['jelszó']));
